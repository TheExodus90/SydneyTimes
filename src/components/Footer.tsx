      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="block text-gray-600 hover:text-gray-900 font-['Cormorant_Garamond']">NewsHub is your trusted source for the latest news and in-depth analysis.</p>
          </div>
          <div>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 text-center">
          <p className="text-gray-500">&copy; {new Date().getFullYear()} NewsHub. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
